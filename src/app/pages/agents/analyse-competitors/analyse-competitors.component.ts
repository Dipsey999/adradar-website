...
@Component({
  ...
  template: `
    ...
    <section class="relative pt-12 lg:pt-20 pb-16 lg:pb-20 overflow-hidden">
      <!-- Background -->
      <div class="absolute inset-0 bg-gradient-to-b from-[#edf3ec] via-[#f5f9f4] to-white pointer-events-none -z-10"></div>
      <!-- Large ambient glows -->
      ...
      <div class="max-w-[1200px] mx-auto px-6">
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div class="flex-1 text-left">
            <!-- Badge -->
            <div class="inline-flex items-center gap-2.5 bg-[#edf3ec]/80 backdrop-blur-sm border border-[#dbeddb]/40 rounded-full px-4 py-1.5 mb-6 shadow-[0_2px_12px_-4px_rgba(74,154,66,0.1)]">
            ...
            <div class="flex items-center gap-4 flex-wrap">
              ...
              <a
                href="#"
                class="h-12 px-8 flex items-center justify-center border border-[#dbeddb] rounded-full text-[15px] font-medium text-[#1a4a18] hover:bg-[#edf3ec]/50 hover:border-[#4a9a42]/50 transition-all duration-300"
              >
                Book a Demo
              </a>
            </div>
          ...
          <div class="hidden lg:block w-[460px] shrink-0">
            <div class="agent-constellation relative w-[420px] h-[420px] mx-auto">
              ...
              <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
                ...
                <div class="relative w-[110px] h-[110px] rounded-full bg-gradient-to-br from-[#d4f0cf] to-[#acdfa4] p-[3px] shadow-[0_8px_40px_-4px_rgba(74,154,66,0.35)]">
                  <div class="w-full h-full rounded-full bg-gradient-to-br from-[#edf3ec] to-[#c8e8c2] overflow-hidden">
    ...
    <section class="relative py-14 lg:py-20 overflow-hidden">
      <div class="absolute inset-0 bg-gradient-to-b from-white via-[#f5f9f4] to-[#edf3ec] pointer-events-none -z-10"></div>
      ...
      <div class="max-w-[1200px] mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-5 lg:gap-6">
          ...
          <div class="group relative rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_40px_-10px_rgba(26,74,24,0.2)]">
            <div class="absolute inset-0 bg-gradient-to-br from-[#1a4a18] to-[#234a20]"></div>
            ...
            <div class="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#82c97a]/40 to-transparent"></div>
            <div class="relative p-7 lg:p-8">
              <div class="flex items-start justify-between mb-5">
                <span class="text-[52px] lg:text-[60px] font-bold tracking-[-0.04em] leading-none text-white">3 weeks</span>
                <div class="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center mt-1">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <circle cx="10" cy="10" r="7" stroke="#82c97a" stroke-width="1.5" fill="none"/>
                    <path d="M10 6v4h3" stroke="#82c97a" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </div>
              </div>
          ...
          <!-- Card 2: 0 -->
          <div class="group relative rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_40px_-10px_rgba(26,74,24,0.2)]">
            <div class="absolute inset-0 bg-gradient-to-br from-[#234a20] to-[#1a4a18]"></div>
            <div class="absolute top-[-30%] right-[-20%] w-[60%] h-[80%] bg-radial-[closest-side] from-[#82c97a]/25 to-transparent blur-[40px] pointer-events-none"></div>
            <div class="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#82c97a]/40 to-transparent"></div>
            <div class="relative p-7 lg:p-8">
              <div class="flex items-start justify-between mb-5">
                ...
                <div class="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center mt-1">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path d="M10 2L3 7v6l7 5 7-5V7l-7-5z" stroke="#82c97a" stroke-width="1.5" stroke-linejoin="round" />
          ...
          <div class="group relative rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_40px_-10px_rgba(26,74,24,0.2)]">
            ...
            <div class="relative p-7 lg:p-8">
              <div class="flex items-start justify-between mb-5">
                ...
                <div class="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center mt-1">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <rect x="3" y="11" width="3.5" height="6" rx="1" fill="#82c97a"/>
                    <rect x="8.25" y="7" width="3.5" height="10" rx="1" fill="#82c97a" opacity="0.6"/>
                    <rect x="13.5" y="3" width="3.5" height="14" rx="1" fill="#82c97a" opacity="0.35"/>
                  </svg>
                </div>
              </div>
              <p class="text-[15px] font-semibold text-white/95 leading-[1.4] mb-2">
    ...
    <section class="relative py-14 lg:py-20 overflow-hidden">
      <!-- Background -->
      <div class="absolute inset-0 bg-gradient-to-b from-[#edf3ec] via-[#f4f8f3] to-white pointer-events-none -z-10"></div>
      <!-- Ambient glows -->
      ...
      <div class="max-w-[1200px] mx-auto px-6">
        <div class="flex flex-col lg:flex-row gap-10 lg:gap-14 items-stretch">
          ...
          <div class="lg:w-[58%] flex flex-col">
            ...
            <div class="hidden lg:flex flex-col flex-1 bg-gradient-to-br from-[#f2f8f0] to-[#edf3ec]/80 rounded-2xl border border-[#dbeddb]/25 p-6 mt-2">
              ...
              <div class="flex items-center gap-3 my-3">
                <div class="flex-1 h-[1px] bg-gradient-to-r from-transparent to-[#dbeddb]/40"></div>
                ...
                <div class="flex-1 h-[1px] bg-gradient-to-l from-transparent to-[#dbeddb]/40"></div>
              </div>
              ...
              <div class="mb-4">
                <div class="flex items-center gap-2 mb-3">
                  ...
                  <span class="text-[12px] font-semibold text-[#1a4a18] uppercase tracking-[0.04em]">Full competitive visibility</span>
                </div>
                ...
                <div class="flex gap-[3px] items-end h-[44px]">
                  ...
                  <div class="flex-1 bg-gradient-to-t from-[#4a9a42] to-[#82c97a] rounded-[3px] h-[66%]"></div>
                  <div class="flex-1 bg-gradient-to-t from-[#4a9a42] to-[#82c97a] rounded-[3px] h-[72%]"></div>
                  <div class="flex-1 bg-gradient-to-t from-[#4a9a42] to-[#82c97a] rounded-[3px] h-[68%]"></div>
                  <div class="flex-1 bg-gradient-to-t from-[#82c97a] to-[#acdfa4] rounded-[3px] h-[64%]"></div>
                  <div class="flex-1 bg-gradient-to-t from-[#82c97a] to-[#acdfa4] rounded-[3px] h-[70%]"></div>
                  <div class="flex-1 bg-gradient-to-t from-[#acdfa4] to-[#d6f0d2] rounded-[3px] h-[66%]"></div>
                  <div class="flex-1 bg-gradient-to-t from-[#acdfa4] to-[#d6f0d2] rounded-[3px] h-[62%]"></div>
                </div>
                <div class="flex items-center justify-between mt-1.5">
                  <span class="text-[10px] text-[#4a9a42] font-medium">Continuous monitoring</span>
                  <span class="text-[10px] text-[#4a9a42]">All competitors tracked</span>
                </div>
              </div>
              ...
              <!-- Stats row -->
              <div class="grid grid-cols-3 gap-3 pt-4 border-t border-[#dbeddb]/20">
                <div>
                  <p class="text-[24px] font-bold text-[#1a4a18] tracking-[-0.03em] leading-none">48hr</p>
                  <p class="text-[11px] font-medium text-[#374151] mt-1">Detection time</p>
                </div>
                <div class="text-center">
                  <p class="text-[24px] font-bold text-[#1a4a18] tracking-[-0.03em] leading-none">100%</p>
                  <p class="text-[11px] font-medium text-[#374151] mt-1">Coverage</p>
                </div>
                <div class="text-right">
                  <p class="text-[24px] font-bold text-[#1a4a18] tracking-[-0.03em] leading-none">35%</p>
          ...
          <div class="lg:w-[42%] flex flex-col">
            ...
            <div class="relative flex items-center justify-center py-2.5 z-10">
              <div class="absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-[2px] bg-gradient-to-b from-[#e5e7eb] via-[#dbeddb] to-[#4a9a42]"></div>
            ...
            <div class="group relative rounded-2xl flex-1 transition-all duration-300">
              ...
              <div class="relative bg-gradient-to-br from-[#f2f8f0] via-[#e8f3e6] to-[#dff0dc] rounded-2xl border-2 border-[#dbeddb] p-5 lg:p-6 shadow-[0_8px_30px_-8px_rgba(74,154,66,0.15)] group-hover:shadow-[0_16px_50px_-12px_rgba(74,154,66,0.22)] flex flex-col h-full">
                <div class="shimmer-sweep absolute inset-0 pointer-events-none z-10 rounded-2xl"></div>

                <!-- Header -->
                <div class="flex items-center justify-between mb-4">
                  <div class="flex items-center gap-2.5">
                    <div class="w-9 h-9 rounded-full bg-gradient-to-br from-[#d4f0cf] to-[#acdfa4] p-[2px] shadow-[0_4px_12px_-2px_rgba(74,154,66,0.3)]">
                      <div class="w-full h-full rounded-full bg-[#acdfa4] overflow-hidden">
                        <img src="/agents/Analyse competitors LinkedIn Ads.png" alt="" class="w-full h-full object-cover" />
                      </div>
                    </div>
                    <div>
                      <h3 class="text-[14px] font-bold text-[#1a4a18] leading-tight">AdRadar Competitor Intelligence</h3>
                      <p class="text-[11px] text-[#4a9a42] mt-0.5">Automated monitoring</p>
                    </div>
                  </div>
                  <span class="text-[10px] font-bold tracking-[0.06em] uppercase text-[#1a4a18] bg-[#d6f0d2] rounded-full px-2.5 py-0.5">Full Intel</span>
                </div>
                ...
                <div class="bg-white/60 backdrop-blur-sm rounded-xl border border-[#dbeddb]/20 p-3.5 mb-4">
                  <p class="text-[10px] font-bold tracking-[0.06em] uppercase text-[#4a9a42] mb-2.5">Impact when enabled</p>
                  <div class="grid grid-cols-3 gap-2">
                    <div class="text-center">
                      <p class="text-[20px] font-bold text-[#1a4a18] tracking-[-0.02em] leading-none">48hr</p>
                      <p class="text-[10px] text-[#6b7280] mt-1 leading-tight">Detection<br/>time</p>
                    </div>
                    <div class="text-center border-l border-r border-[#dbeddb]/20">
                      <p class="text-[20px] font-bold text-[#1a4a18] tracking-[-0.02em] leading-none">100%</p>
                      <p class="text-[10px] text-[#6b7280] mt-1 leading-tight">Competitor<br/>coverage</p>
                    </div>
                    <div class="text-center">
                      <p class="text-[20px] font-bold text-[#1a4a18] tracking-[-0.02em] leading-none">35%</p>
                ...
                <div class="flex items-center justify-between pt-3.5 border-t border-[#dbeddb]/15">
                  <div class="flex items-center gap-2.5">
                    <div class="flex -space-x-1.5">
                      <div class="w-5 h-5 rounded-full bg-[#b8dff0] ring-2 ring-[#f2f8f0] overflow-hidden"><img src="/agents/Company Blocking Agent.png" alt="" class="w-full h-full object-cover"/></div>
                      <div class="w-5 h-5 rounded-full bg-[#a8d1dc] ring-2 ring-[#f2f8f0] overflow-hidden"><img src="/agents/Impression Capping Agent.png" alt="" class="w-full h-full object-cover"/></div>
                      <div class="w-5 h-5 rounded-full bg-[#ee95a0] ring-2 ring-[#f2f8f0] overflow-hidden"><img src="/agents/Title Blocking Agent.png" alt="" class="w-full h-full object-cover"/></div>
                    </div>
          ...
          <div class="max-w-[1300px] mx-auto px-6 md:px-10 lg:px-20 w-full">
            <div class="flex gap-8 lg:gap-16 items-stretch">
              ...
              <div class="hidden md:flex md:w-[320px] lg:w-[420px] xl:w-[500px] shrink-0 items-center justify-center">
                <div class="bg-gradient-to-br from-[#edf3ec] to-[#dff0dc] rounded-2xl lg:rounded-3xl overflow-hidden relative w-full h-full">
                  ...
                  >
                    <div class="bg-white rounded-xl shadow-[0_2px_12px_-3px_rgba(0,0,0,0.08)] p-4 lg:p-5">
                      ...
                      <!-- Competitor rows -->
                      <div class="space-y-3">
                        <div class="flex items-center justify-between bg-[#f2f8f0] rounded-lg px-3 py-2.5">
                          <div class="flex items-center gap-2.5">
                            <div class="w-8 h-8 rounded-full bg-[#e8f3e6] flex items-center justify-center">
                              <span class="text-[11px] font-bold text-[#1a4a18]">CX</span>
                            </div>
                            <div>
                              <p class="text-[12px] font-semibold text-[#1a4a18]">CompetitorX</p>
                              <p class="text-[10px] text-[#6b7280]">linkedin.com/company/competitorx</p>
                            </div>
                          </div>
                          <span class="text-[9px] font-bold tracking-[0.04em] uppercase text-[#1a4a18] bg-[#acdfa4]/40 px-2 py-0.5 rounded-full">Monitoring</span>
                        </div>
                        <div class="flex items-center justify-between bg-[#f8faf7] rounded-lg px-3 py-2.5">
                          <div class="flex items-center gap-2.5">
                            <div class="w-8 h-8 rounded-full bg-[#e8f3e6] flex items-center justify-center">
                      ...
                      <div class="mt-4 flex items-center gap-2 text-[11px] text-[#4a9a42] font-medium">
                        <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M4 8.5l3 3 5-6" stroke="#4a9a42" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                    ...
                    <div class="bg-white rounded-xl shadow-[0_2px_12px_-3px_rgba(0,0,0,0.08)] p-4 lg:p-5">
                      ...
                      <div class="bg-[#fef3c7]/40 border border-[#fde68a]/50 rounded-lg p-3 mb-3">
                        <div class="flex items-center gap-2 mb-2">
                          <div class="w-6 h-6 rounded-full bg-[#e8f3e6] flex items-center justify-center">
                            <span class="text-[9px] font-bold text-[#1a4a18]">CX</span>
                          </div>
                      ...
                      <!-- Additional detected -->
                      <div class="space-y-2">
                        <div class="bg-[#f2f8f0] border border-[#dbeddb]/30 rounded-lg px-3 py-2 flex items-center justify-between">
                          <div class="flex items-center gap-2">
                            <div class="w-6 h-6 rounded-full bg-[#e8f3e6] flex items-center justify-center">
                              <span class="text-[9px] font-bold text-[#1a4a18]">RV</span>
                            </div>
                            <span class="text-[11px] font-medium text-[#374151]">RivalTech — 3 new ads</span>
                          </div>
                          <span class="text-[9px] font-bold text-[#4a9a42] bg-[#f0fdf4] px-2 py-0.5 rounded-full">View</span>
                        </div>
                      </div>
                    ...
                    <div class="bg-white rounded-xl shadow-[0_2px_12px_-3px_rgba(0,0,0,0.08)] p-4 lg:p-5">
                      <div class="flex items-center gap-2 mb-4">
                        <div class="w-7 h-7 rounded-lg bg-gradient-to-br from-[#d6f0d2] to-[#acdfa4] flex items-center justify-center">
                          <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M2 12l3-4 3 2 4-6" stroke="#1a4a18" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                        </div>
                      ...
                      <div class="space-y-3 mb-3">
                        <div>
                          <div class="flex items-center justify-between mb-1">
                            ...
                            <span class="text-[10px] text-[#4a9a42] font-semibold">Every 2 weeks</span>
                          </div>
                          <div class="flex gap-1 h-[8px]">
                            <div class="flex-1 bg-[#4a9a42] rounded-sm"></div>
                            <div class="flex-1 bg-[#82c97a] rounded-sm"></div>
                            <div class="flex-1 bg-[#4a9a42] rounded-sm"></div>
                            <div class="flex-1 bg-[#acdfa4] rounded-sm"></div>
                            <div class="flex-1 bg-[#82c97a] rounded-sm"></div>
                            <div class="flex-1 bg-[#4a9a42] rounded-sm"></div>
                          </div>
                        </div>
                      ...
                      <div class="bg-[#f2f8f0] rounded-lg px-3 py-2">
                        <p class="text-[10px] text-[#4a9a42] font-medium">
                    ...
                    <div class="bg-white rounded-xl shadow-[0_2px_12px_-3px_rgba(0,0,0,0.08)] p-4 lg:p-5">
                      ...
                      <div class="bg-[#fef3c7]/30 border border-[#fde68a]/40 rounded-lg p-3 mb-3">
                        ...
                        <div class="space-y-2">
                          ...
                          <div class="flex items-start gap-2">
                            <div class="w-4 h-4 rounded-full bg-[#d6f0d2] flex items-center justify-center shrink-0 mt-0.5">
                              <svg width="6" height="6" viewBox="0 0 10 10" fill="none"><path d="M2 5.5l2 2 4-4.5" stroke="#1a4a18" stroke-width="1.5" stroke-linecap="round"/></svg>
                            </div>
                            <div>
                              <p class="text-[10px] font-semibold text-[#4a9a42] uppercase tracking-[0.03em]">New angle</p>
                      ...
                      <!-- Competitive signal -->
                      <div class="bg-[#f2f8f0] border border-[#dbeddb]/30 rounded-lg px-3 py-2 flex items-center gap-2">
                        <div class="w-5 h-5 rounded-full bg-[#acdfa4] flex items-center justify-center shrink-0">
                          <svg width="10" height="10" viewBox="0 0 12 12" fill="none"><path d="M6 2v8M3 6h6" stroke="#1a4a18" stroke-width="1.3" stroke-linecap="round"/></svg>
                        </div>
                        <span class="text-[10px] text-[#1a4a18] font-semibold">Competitive Signal: Now targeting your price-sensitive segment</span>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div class="bg-white rounded-xl shadow-[0_2px_12px_-3px_rgba(0,0,0,0.08)] p-4 lg:p-5">
                      ...
                      <div class="space-y-2 mb-4">
                        <div class="flex items-start gap-2 bg-[#f2f8f0] rounded-lg p-2.5">
                          <div class="w-5 h-5 rounded-full bg-gradient-to-br from-[#4a9a42] to-[#1a4a18] flex items-center justify-center shrink-0 mt-0.5">
                        ...
                        <div class="flex items-start gap-2 bg-[#f8faf7] rounded-lg p-2.5">
                          <div class="w-5 h-5 rounded-full bg-[#acdfa4]/60 flex items-center justify-center shrink-0 mt-0.5">
                            <span class="text-[9px] font-bold text-[#1a4a18]">3</span>
                          </div>
                          <div>
    ...
    <!-- ═══════════════════════════════════════════
         ...
         ═══════════════════════════════════════════ -->
    <section class="relative py-14 lg:py-20 overflow-hidden">
      <div class="absolute inset-0 bg-gradient-to-b from-[#eaf5e8] via-[#f2f8f0] to-[#eaf5e8] pointer-events-none -z-10"></div>
      ...
      <div class="max-w-[1100px] mx-auto px-6">
        ...
        <div class="hidden md:block">
          <div class="bg-white rounded-2xl border border-[#dbeddb]/30 overflow-hidden shadow-[0_4px_24px_-4px_rgba(74,154,66,0.1)]">

            <!-- Table Header -->
            <div class="grid grid-cols-[1fr_1fr_1.15fr]">
              <!-- Capability header -->
              <div class="bg-[#f8faf7] p-5 border-b border-[#e5e7eb]/60">
                <span class="text-[13px] font-semibold text-[#6b7280] uppercase tracking-[0.04em]">Capability</span>
              </div>
              <!-- Without agent header -->
              <div class="bg-[#f8faf7] p-5 border-b border-[#e5e7eb]/60 border-l border-l-[#e5e7eb]/40">
                <div class="flex items-center gap-2">
              ...
              <!-- With AdRadar header -->
              <div class="bg-gradient-to-r from-[#1a4a18] to-[#234a20] p-5 border-b border-[#1a4a18]">
            ...
            @for (row of comparisonRows; track row.capability; let i = $index; let even = $even) {
              <div
                class="group grid grid-cols-[1fr_1fr_1.15fr] border-t border-[#e5e7eb]/40 transition-colors duration-200 hover:bg-[#f6faf5]/60"
              >
                <!-- Capability -->
                <div class="p-5 flex items-center gap-3">
                  <div class="w-8 h-8 rounded-lg bg-[#f2f8f0] flex items-center justify-center shrink-0">
                    @switch (i) {
                      @case (0) {
                      ...
                      @case (4) {
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="6" r="3" stroke="#4a9a42" stroke-width="1.5"/><path d="M4 13c0-2.2 1.8-4 4-4s4 1.8 4 4" stroke="#4a9a42" stroke-width="1.5" stroke-linecap="round"/></svg>
                      }
                      @case (5) {
                ...
                <!-- With AdRadar value -->
                <div class="p-5 flex items-center gap-2.5 bg-[#f2f8f0]/70 group-hover:bg-[#e8f3e6]/60 transition-colors border-l-2 border-l-[#4a9a42]/20">
                  ...
                  <span class="text-[14px] text-[#1a4a18] font-semibold">{{ row.withAgent }}</span>
                </div>
              </div>
            }
        ...
        <div class="md:hidden space-y-3">
          ...
          <div class="flex items-center gap-3 bg-gradient-to-r from-[#1a4a18] to-[#234a20] rounded-xl px-4 py-3">
            <div class="w-8 h-8 rounded-full bg-[#acdfa4] p-[2px] ring-2 ring-white/20 overflow-hidden shrink-0">
          ...
          @for (row of comparisonRows; track row.capability; let i = $index) {
            <div class="bg-white rounded-xl border border-[#e5e7eb]/60 overflow-hidden shadow-[0_1px_4px_-1px_rgba(0,0,0,0.04)]">
              ...
              <div class="grid grid-cols-2">
                ...
                <div class="p-4 bg-[#f2f8f0]/70 border-l-2 border-l-[#4a9a42]/20">
                  <div class="flex items-center gap-1.5 mb-2">
                  ...
                  <p class="text-[13px] text-[#1a4a18] font-semibold">{{ row.withAgent }}</p>
                </div>
              </div>
            </div>
          }
    ...
    <section class="relative py-16 lg:py-22 overflow-hidden">
      <!-- Dark background -->
      <div class="absolute inset-0 bg-gradient-to-br from-[#0f2e16] via-[#1a4a18] to-[#122d15] pointer-events-none -z-10"></div>
      <!-- Ambient glows -->
      ...
      <div class="absolute bottom-[-20%] right-[-10%] w-[50%] h-[70%] bg-radial-[closest-side] from-[#82c97a]/10 to-transparent blur-[100px] pointer-events-none -z-10"></div>
      ...
      <div class="max-w-[1200px] mx-auto px-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-10 lg:mb-14">
          <div class="max-w-[600px]">
            ...
            <h2 class="text-[28px] md:text-[36px] lg:text-[44px] font-bold leading-[1.08] tracking-[-0.025em] text-white">
              ...
              <span class="cta-gradient-text">Competitive advantage.</span>
            </h2>
          </div>
        ...
        <div class="grid md:grid-cols-3 gap-5 lg:gap-6">
          ...
          <div class="group relative rounded-2xl overflow-hidden transition-all duration-500 hover:-translate-y-1">
            ...
            <div class="relative bg-[#ffffff]/[0.06] backdrop-blur-md rounded-2xl border border-white/[0.08] p-6 lg:p-7 h-full group-hover:bg-[#ffffff]/[0.09] transition-colors duration-500">
              ...
              <div class="flex items-center gap-2 mb-6">
                <span class="text-[12px] font-medium text-[#fca5a5] bg-[#ef4444]/20 px-2.5 py-1 rounded-full">2-3 wks</span>
                ...
                <span class="text-[12px] font-semibold text-[#86efac] bg-[#22c55e]/25 px-2.5 py-1 rounded-full">48 hrs</span>
              </div>
              ...
              <div class="relative w-[140px] h-[140px] mx-auto mb-6">
                ...
                <div class="absolute inset-0 flex items-center justify-center">
                  <span class="text-[32px] font-bold text-white tracking-[-0.03em]">48 hrs</span>
                </div>
              </div>

              <h3 class="text-[18px] font-bold text-white mb-1.5 text-center">Average detection time</h3>
          ...
          <!-- Card 2: 0 hrs -->
          <div class="group relative rounded-2xl overflow-hidden transition-all duration-500 hover:-translate-y-1">
            <div class="absolute -inset-[1px] rounded-2xl bg-gradient-to-br from-[#82c97a]/35 via-[#acdfa4]/15 to-[#82c97a]/35 opacity-50 group-hover:opacity-100 blur-[2px] transition-opacity duration-500"></div>
            <div class="relative bg-[#ffffff]/[0.08] backdrop-blur-md rounded-2xl border border-white/[0.10] p-6 lg:p-7 h-full group-hover:bg-[#ffffff]/[0.12] transition-colors duration-500">
              ...
              <!-- Before/After badge -->
              <div class="flex items-center gap-2 mb-6">
                <span class="text-[12px] font-medium text-[#fca5a5] bg-[#ef4444]/20 px-2.5 py-1 rounded-full">Hours/wk</span>
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M3 7h8M8 4l3 3-3 3" stroke="#acdfa4" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                <span class="text-[12px] font-semibold text-[#86efac] bg-[#22c55e]/25 px-2.5 py-1 rounded-full">0 hrs</span>
              </div>
              ...
              <div class="flex items-end gap-3 justify-center h-[140px] mb-6 px-2">
                ...
                <div class="flex flex-col items-center gap-2 flex-1">
                  <div class="w-full max-w-[48px] rounded-lg h-[100px] relative overflow-hidden bg-[#ef4444]/25 border border-[#ef4444]/30">
                ...
                <!-- After bars -->
                <div class="flex flex-col items-center gap-2 flex-1">
                  <div class="w-full max-w-[48px] rounded-lg h-[8px] relative overflow-hidden bg-[#4a9a42]/30 border border-[#82c97a]/30">
                    <div class="absolute inset-0 bg-gradient-to-t from-[#1a4a18] via-[#4a9a42]/80 to-[#82c97a]/60"></div>
                  </div>
                  <span class="text-[10px] text-[#82c97a] font-semibold">After</span>
                </div>
                <!-- Extra label bars -->
                <div class="flex flex-col items-center gap-2 flex-1">
                  <div class="w-full max-w-[48px] rounded-lg h-[120px] relative overflow-hidden bg-[#4a9a42]/20 border border-[#82c97a]/25">
                    <div class="absolute inset-0 bg-gradient-to-t from-[#1a4a18]/80 via-[#4a9a42]/60 to-[#82c97a]/40"></div>
                  </div>
                  <span class="text-[10px] text-[#82c97a] font-medium">Auto</span>
                </div>
                <div class="flex flex-col items-center gap-2 flex-1">
                  <div class="w-full max-w-[48px] rounded-lg h-[95px] relative overflow-hidden bg-[#4a9a42]/15 border border-[#acdfa4]/20">
                    <div class="absolute inset-0 bg-gradient-to-t from-[#1a4a18]/60 via-[#82c97a]/40 to-[#acdfa4]/30"></div>
                  </div>
                  <span class="text-[10px] text-[#acdfa4] font-medium">24/7</span>
                </div>
              </div>

              <div class="text-center">
                <p class="text-[48px] font-bold text-white tracking-[-0.04em] leading-none mb-1.5">0 hrs</p>
                <h3 class="text-[18px] font-bold text-white mb-1.5">Manual monitoring time</h3>
          ...
          <div class="group relative rounded-2xl overflow-hidden transition-all duration-500 hover:-translate-y-1">
            ...
            <div class="relative bg-[#ffffff]/[0.06] backdrop-blur-md rounded-2xl border border-white/[0.08] p-6 lg:p-7 h-full group-hover:bg-[#ffffff]/[0.09] transition-colors duration-500">
              ...
              <!-- Before/After badge -->
              <div class="flex items-center gap-2 mb-6">
                <span class="text-[12px] font-medium text-[#fca5a5] bg-[#ef4444]/20 px-2.5 py-1 rounded-full">Weeks</span>
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M3 7h8M8 4l3 3-3 3" stroke="#acdfa4" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                <span class="text-[12px] font-semibold text-[#86efac] bg-[#22c55e]/25 px-2.5 py-1 rounded-full">35% faster</span>
              </div>
              ...
              <div class="relative mb-6 px-1">
                ...
                <div class="mb-4">
                  <div class="flex items-center justify-between mb-1.5">
                    <span class="text-[11px] text-white/70 font-medium uppercase tracking-[0.04em]">Manual response time</span>
                    <span class="text-[12px] text-white/80 font-semibold">3-4 weeks</span>
                  </div>
                  <div class="h-[12px] bg-white/[0.08] rounded-full overflow-hidden border border-white/[0.10]">
                    <div class="h-full w-full bg-gradient-to-r from-[#ef4444]/60 to-[#ef4444]/30 rounded-full"></div>
                  </div>
                </div>
                <!-- Automated response time -->
                <div class="mb-4">
                  <div class="flex items-center justify-between mb-1.5">
                    <span class="text-[11px] text-[#86efac] font-semibold uppercase tracking-[0.04em]">With AdRadar</span>
                    <span class="text-[12px] text-[#86efac] font-bold">~2 weeks</span>
                  </div>
                  <div class="h-[12px] bg-white/[0.08] rounded-full overflow-hidden border border-[#22c55e]/25">
                    <div class="h-full w-[65%] bg-gradient-to-r from-[#22c55e] to-[#86efac] rounded-full"></div>
                  </div>
                </div>
                <!-- Arrow showing improvement -->
                <div class="flex items-center gap-2 mt-4 bg-[#22c55e]/10 border border-[#22c55e]/15 rounded-lg px-3 py-2.5">
                  <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M4 8h8M9.5 5.5L12 8l-2.5 2.5" stroke="#86efac" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                  <span class="text-[11px] text-[#86efac] font-medium">Teams respond faster to positioning pivots</span>
                </div>
              </div>

              <div class="text-center">
                <p class="text-[48px] font-bold text-white tracking-[-0.04em] leading-none mb-1.5">35%</p>
                <h3 class="text-[18px] font-bold text-white mb-1.5">Faster counter-response</h3>
    ...
    <!-- ═══════════════════════════════════════════
         ...
         ═══════════════════════════════════════════ -->
    <section class="relative py-14 lg:py-20 overflow-hidden">
      <div class="absolute inset-0 bg-gradient-to-b from-[#f5f9f4] via-[#f8faf7] to-white pointer-events-none -z-10"></div>
    ...
    <section class="relative py-14 lg:py-20 overflow-hidden">
      ...
      <div class="relative max-w-[960px] mx-auto px-6">
        <div class="relative rounded-[28px] lg:rounded-[32px] overflow-clip">
          <!-- CTA Background -->
          <div class="absolute inset-0 bg-gradient-to-br from-[#1a4a18] via-[#234a20] to-[#1a4a18]"></div>
          ...
          <div class="relative px-8 md:px-12 lg:px-16 py-16 lg:py-20 text-center">
            ...
            <div class="relative w-20 h-20 mx-auto mb-8">
              ...
              <div class="relative w-full h-full rounded-full bg-gradient-to-br from-[#d4f0cf] to-[#acdfa4] p-[2px] shadow-[0_8px_30px_-6px_rgba(172,223,164,0.5)]">
            ...
            <h2 class="text-[28px] md:text-[38px] lg:text-[44px] font-bold leading-[1.1] tracking-[-0.025em] text-white mb-4">
              ...
              <br class="hidden md:block" />
              <span class="cta-gradient-text">Monitor competitors automatically.</span>
            </h2>
            <p class="text-[17px] text-[#acdfa4] leading-[1.65] max-w-[520px] mx-auto mb-10">
              Connect your LinkedIn Ads account in 2 minutes. The Competitor Ads Copilot
            ...
            <div class="flex items-center justify-center gap-4 flex-wrap">
              <a
                href="#"
                class="group inline-flex items-center gap-3 bg-white hover:bg-[#f2f8f0] text-[#1a4a18] rounded-full pl-6 pr-1.5 py-1.5 transition-all duration-300 hover:shadow-[0_8px_30px_-6px_rgba(255,255,255,0.3)] hover:scale-[1.03]"
              >
  ...
  styles: [`
    ...
    .section-gradient-text {
      background: linear-gradient(135deg, #1a4a18 0%, #4a9a42 60%, #82c97a 100%);
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent;
      background-clip: text;
    }

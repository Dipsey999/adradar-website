            ...
            <div class="hidden lg:flex flex-col flex-1 bg-gradient-to-br from-[#fef4f0] to-[#fef6f3]/80 rounded-2xl border border-[#f5a896]/25 p-6 mt-2">
              ...
              <div class="mb-4">
                ...
                <div class="flex items-center justify-between mt-1.5">
                  ...
                  <span class="text-[10px] text-[#6b7280]">Underbidding (no reach)</span>
                </div>
              </div>
                ...
                <div class="flex items-center justify-between mb-4">
                  <div class="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p class="text-[11px] text-[#6b7280] mt-0.5">Manual, static bids</p>
                    </div>
                  </div>
            ...
            <div class="grid grid-cols-[1fr_1fr_1.15fr]">
              ...
              <div class="bg-[#faf8f8] p-5 border-b border-[#e5e7eb]/60 border-l border-l-[#e5e7eb]/40">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-[13px] font-bold text-[#111827] uppercase tracking-[0.04em]">Without optimization</span>
                </div>
              </div>

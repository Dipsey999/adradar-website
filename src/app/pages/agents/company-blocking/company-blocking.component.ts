            ...
            <div class="flex md:hidden justify-center gap-2 mt-6">
              @for (step of steps; track step.number; let i = $index) {
                <button
                  ...
                  [ngClass]="isStepCurrent(i) ? 'bg-[#e8573a] w-6' : 'bg-[#d1d5db]'"
                  (click)="scrollToStep(i)"
                ></button>
              }
            </div>
        ...
        <div class="relative rounded-[28px] lg:rounded-[32px] bg-white overflow-clip shadow-[0_0_24px_4px_rgba(0,0,0,0.12)] pt-12 lg:pt-16 pb-[120px] lg:pb-[160px] px-8 md:px-12 lg:px-16">
          <div class="relative z-10 text-left md:text-center max-w-[700px] mx-auto">
            <h2 class="text-[28px] md:text-[38px] lg:text-[44px] font-bold leading-[1.1] tracking-[-0.025em] text-[#111827] mb-3">
              Stop paying for impressions on companies that will
              <br class="hidden md:block" />
              <span
            ...
            <p class="text-[15px] md:text-[17px] text-[#4b5563] max-w-none md:max-w-[520px] mx-0 md:mx-auto mb-6 leading-[1.65]">
              Connect your LinkedIn Ads account in 2 minutes. The Company Blocking Agent
          ...
          <div class="absolute bottom-6 left-1/2 -translate-x-1/2 w-[110%] max-w-[1310px] h-[200px] hidden md:block">
            <svg class="absolute inset-0 w-full h-full" viewBox="0 0 1310 200" fill="none" preserveAspectRatio="xMidYMid meet">
              <path d="M 30 55 Q 200 95 400 135 Q 550 165 655 175 Q 760 165 910 135 Q 1110 95 1280 55" stroke="#9dcce7" stroke-width="2" fill="none" opacity="0.4"/>
            </svg>
            ...
            <!-- CENTER: Company Blocking -->
            <div class="absolute" style="left: 46%; bottom: 15px">
              <div class="relative">
                <div class="w-[84px] h-[84px] rounded-full bg-[#b8dff0] p-[2px] shadow-lg ring-4 ring-[#b8dff0]/30">
            ...
            <div class="absolute" style="left: 90%; bottom: 110px">
              <div class="relative">
                <div class="w-[52px] h-[52px] rounded-full bg-[#ee95a0] p-[2px] shadow-md">
...
export class CompanyBlockingComponent implements OnInit, OnDestroy {
  ...
  relatedAgents: RelatedAgent[] = [
    ...
    },
    {
      ...
      avatarBg: '#acdfa4',
      description:
        'Company delivery data feeds into Strategy Copilot audience and funnel recommendations — so structural campaign decisions are based on which ICP accounts are actually being reached.',
      accentColor: '#4a9a42',
